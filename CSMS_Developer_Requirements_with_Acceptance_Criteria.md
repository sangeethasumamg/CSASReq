...
8. The Case Details section should display the following editable fields:
   ...
   - Case Type (Dropdown: IV-D, No - Mandatory)
   - Sub Type (Dropdown: Federal foster care, Medicaid only, Never assistance, etc., No - Mandatory)
...
**Document Status**: This document contains complete requirements with acceptance criteria for:
- ✅ INTAKE MODULE (Complete - 7 user stories)
- ✅ CASE REGISTRATION MODULE (Complete - 14 user stories)

---

## Related Module Documents

The remaining modules have been documented in separate files:

- **Case Management Module**: See `CSMS_Module_3_Case_Management_Requirements.md`
- **Locate Module**: See `CSMS_Module_4_Locate_Requirements.md`
- **Establishment Module**: See `CSMS_Module_5_Establishment_Requirements.md`
- **Enforcement Module**: See `CSMS_Module_6_Enforcement_Requirements.md`
- **Finance Module**: See `CSMS_Module_7_Finance_Requirements.md`

For a complete index of all modules, see: `CSMS_All_Modules_Index.md`

---

Each module follows the same format with detailed user stories and acceptance criteria for developer implementation.
